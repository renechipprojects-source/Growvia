...
export const Route = createFileRoute("/principal/school-branding")({
  ...
  head: () => ({
    meta: [
      { title: "School Branding Settings — Principal Portal" },
      { name: "description", content: "Configure school identity, logo, login page branding, and contact details." },
    ],
  }),
  component: PrincipalSchoolBrandingPage,
});

function PrincipalSchoolBrandingPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="School Branding & Identity Settings"
