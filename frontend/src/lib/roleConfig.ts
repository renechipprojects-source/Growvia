...
export const ROLES: Record<Role, RoleTheme> = {
  ...
  principal: {
    ...
    nav: [
      ...
      { to: "/principal/attendance/students", label: "Attendance", icon: UserCheck },
      ...
      { to: "/principal/circulars", label: "Circulars", icon: Megaphone },
      { to: "/principal/messages", label: "Messages", icon: MessageSquare },
    ],
  },
  office: {
    role: "office",
