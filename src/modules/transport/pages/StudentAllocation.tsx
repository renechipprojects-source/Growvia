...
export function StudentAllocationPage() {
  return (
    <div className="mx-auto max-w-[1500px]">
      <PageHeader title="Student Transport Allocation" description="Assign students to routes, vehicles and pickup points."
        actions={<Button><Plus className="mr-2 h-4 w-4" />Allocate Student</Button>} />
